...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'enc_password' => ['type' => 'string', 'length' => 225, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'enc_password' => 'Lorem ipsum dolor sit amet',
            ],
        ];
        parent::init();
    }
